...
I remembered Bramus sharing his post [on scroll _triggered_ animations](https://developer.chrome.com/blog/scroll-triggered-animations). As Bramus mentions, scroll triggered animations "trigger when crossing a specific scroll offset". This is exactly what's required to avoid the problem Kevin mentioned above.
